...
| 👤 **人物检测** | 基于 YOLOv11 的视频人物出镜检测，自动标记有人物的片段 |
| ✂️ **自动剪辑** | 根据音乐匹配或人物检测结果自动标记并剪辑视频片段 |
...
- 👤 **person-detector** - 基于 YOLOv11 的人物出镜检测
...
| 输入内容 | 3 小时视频 + 160 首本地音乐库 |
| 处理流程 | 人声分离 → 音频指纹提取 → 全库匹配 → 片段标记 |
| 总耗时 | 9 分钟 |
...
| 3️⃣ | **开始识别** | 点击「开始识别」，自动提取音频 → 分离人声 → 匹配指纹；或使用「人物检测」标记有人物出镜的片段 |
